                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div class="col-span-1 md:col-span-2">
                        ...
                        <table class="table-auto w-full mb-6">
                            <thead>
                                <tr class="text-left border-b border-gray-700 text-gray-200">
                        ...
                        <div class="space-y-8">
                            @foreach ($perfilUsuario as $key => $perfil)
                                <div class="space-y-2">
                                    ...
                                    <p class="text-justify text-gray-200">{{ $perfil['texto'] }}</p>

                                    <p class="font-medium mt-2">
                                        <span class="font-bold">Palavra-chave:</span>
                                        <span class="text-gray-200">{{ $perfil['palavra-chave'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Arquétipo simbólico:</span>
                                        <span class="text-gray-200">{{ $perfil['arquetipo'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Força essencial</span>
                                        <span class="text-gray-200">{{ $perfil['forca-essencial'] }}</span>
                                    </p>
                                    ...
                                    <p class="font-medium">
                                        ...
                                        <span class="text-gray-200">{{ $perfil['aprendizagem'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Relacionamentos amorosos:</span>
                                        <span class="text-gray-200">{{ $perfil['relacionamento'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Comunicação em público:</span>
                                        <span class="text-gray-200">{{ $perfil['comunicacao'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Vendas:</span>
                                        <span class="text-gray-200">{{ $perfil['venda'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Liderança:</span>
                                        <span class="text-gray-200">{{ $perfil['lideranca'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Integração simbólica:</span>
                                        <span class="text-gray-200">{{ $perfil['integracao'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Dicas:</span>
                                        <span class="text-gray-200">{{ $perfil['dicas'] }}</span>
                                    </p>

                                    <p class="font-medium">
                                        <span class="font-bold">Cuidados:</span>
                                        <span class="text-gray-200">{{ $perfil['cuidados'] }}</span>
                                    </p>
                                </div>
                            @endforeach
                        </div>
