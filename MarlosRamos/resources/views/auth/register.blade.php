    ...
    <div x-data="{ tab: 'student' }" class="max-w-xl mx-auto">
        ...
        {{-- <div class="flex flex-col sm:flex-row flex-wrap border-b border-gray-200 mb-4">
            <button type="button" @click="tab = 'student'"
                :class="tab === 'student' ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-gray-200'"
            ...
            <button type="button" @click="tab = 'teacher'"
                :class="tab === 'teacher' ? 'border-b-2 border-indigo-600 text-indigo-600' : 'text-gray-200'"
                class="py-2 px-4 font-medium text-sm hover:text-gray-200 hover:border-b-2 hover:border-gray-300">
                Professor
            </button>
        </div> --}}
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="col-span-2 flex items-center justify-end mt-4">
                    <a class="underline text-sm text-gray-200 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                        href="{{ route('login') }}">
                        {{ __('Já tem cadastro?') }}
                    </a>
