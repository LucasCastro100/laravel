...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
    <div class="relative min-h-screen flex flex-col selection:bg-[#FF2D20] selection:text-white">
        ...
        <div class="absolute inset-0 bg-cover bg-center bg-no-repeat" style="background-image: url('/images/background.jpg');">
            <div class="absolute inset-0 bg-black/50"></div> {{-- Overlay escuro opcional --}}
        </div>

        {{-- Container principal --}}
        <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl flex flex-col flex-1 mx-auto">
            ...
            {{-- Conteúdo principal ocupando toda a tela abaixo do menu --}}
            <main class="flex-1 flex flex-col items-center justify-center text-center">
                <h1 class="text-4xl font-bold text-white/80 lg:text-6xl animate-pulse">
                    Novidades em breve 🚀
                </h1>
                
                <h3 class="mt-4 text-lg text-white/80 max-w-2xl">
