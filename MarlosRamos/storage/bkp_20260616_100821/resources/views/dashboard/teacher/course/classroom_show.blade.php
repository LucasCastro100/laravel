                    ...
                    <div class="mx-auto sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 w-full">
                            <div class="col-span-1 lg:col-span-2" x-data @resize.window="$store.video.calcHeight()"
                                ...
                                {{-- COMENTARIO --}}
                                <div class="mt-8">
                                    <h3 class="text-xl font-semibold text-gray-100 dark:text-gray-100 mb-4">Deixe sua
                                    ...
                                    <div class="mt-8">
                                        @if ($comments->isEmpty())
                                            <p class="text-gray-200 dark:text-gray-400 mt-4">Nenhum comentário ainda.
                                        ...
                                        @else
                                            ...
                                            @foreach ($comments as $comment)
                                                <div
                                                    ...
                                                    <p class="text-sm text-gray-200 dark:text-gray-300 mt-2">
                                        ...
                                        <div class="border border-gray-200 dark:border-gray-700 rounded mb-2">
                                            ...
                                            <h2>
                                                <button
                                                    ...
                                                    class="flex items-center justify-between w-full p-4 font-medium text-left text-gray-200 dark:text-gray-300 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700">
                                                    ...
                                                    @foreach ($module->classrooms as $classroom)
                                                        <li>
                                                            <a href="{{ route('classroom.show', ['uuid_classroom' => $classroom->uuid]) }}"
                                                                class="block px-4 py-2 text-sm text-gray-100-600 dark:text-gray-300 hover:text-indigo-500 dark:hover:text-indigo-400">
