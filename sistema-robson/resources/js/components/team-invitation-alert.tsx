...
export default function TeamInvitationAlert({ invitation, mode }: Props) {
    return (
        <Alert
        ...
        >
            ...
            <AlertDescription className="text-blue-900 dark:text-blue-100">
                {mode === 'login'
                    ? `Entre para participar da equipe "${invitation.teamName}".`
                    : `Registre-se para participar da equipe "${invitation.teamName}".`}
            </AlertDescription>
        </Alert>
    );
}
