<x-action-section>
    ...
    <x-slot name="content">
        <div class="max-w-xl text-sm text-gray-600 dark:text-gray-400">
            Se necessário, você pode encerrar todas as suas outras sessões do navegador em todos os seus dispositivos. Algumas das suas sessões recentes estão listadas abaixo; no entanto, esta lista pode não ser completa. Se você acha que sua conta foi comprometida, atualize sua senha.
        </div>
        ...
        <x-dialog-modal wire:model.live="confirmingLogout">
            ...
            <x-slot name="content">
                Digite sua senha para confirmar que deseja sair de outras sessões do navegador em todos os seus dispositivos.
