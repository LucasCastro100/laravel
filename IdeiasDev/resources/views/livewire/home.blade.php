<div>
    <x-slot name="header">
        <div class="w-full text-center">
            <h2 class="font-semibold text-4xl text-white dark:text-white leading-tight inline-block">
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto px-4">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg p-">
                <div class="grid gap-4 grid-cols-1">
                    <div class="p-4">
                        <h2 class="font-semibold text-white mb-4 text-center text-2xl">Transforme Suas Ideias em Projetos
                            Digitais de Sucesso</h2>

                        <p class="font-semibold text-white text-lg mb-4">
                            Transformar ideias em soluções digitais é o que me move. Desde 2021 nosso objetivo é
                            entregar
                    ...
                    <div class="p-4">
                        <h2 class="font-semibold text-white mb-4 text-center text-2xl">Contato</h2>

                        <form wire:submit.prevent="submit_form" class="w-full">
                            <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4">
                                ...
                                <div class="col-span-1 lg:col-span-2">
                                    ...
                                    <x-input id="domain" type="text" wire:model="domain" class="w-full" />
                                ...
                                <div class="col-span-1 md:col-span-2">
                                    ...
                                    <x-input id="url" type="text" wire:model="url" class="w-full" />
                                ...
                                <div class="col-span-1 md:col-span-4 lg:col-span-6">
                                    ...
                                    <x-text-area id="desc" cols="10" rows="5" wire:model="desc" class="w-full"></x-text-area>                                    
