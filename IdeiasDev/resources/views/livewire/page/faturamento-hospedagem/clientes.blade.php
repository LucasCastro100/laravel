            ...
            <tbody class="divide-y divide-gray-800">
                @forelse ($clients as $c)
                    <tr class="hover:bg-gray-800/50">
                        ...
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 text-xs rounded-full {{ $c->status === 'ativo' ? 'bg-green-900 text-green-400' : 'bg-red-900 text-red-400' }}">
                                {{ ucfirst($c->status) }}
                            </span>
                        </td>
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-6 py-12 text-gray-500">Nenhum cliente encontrado.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
