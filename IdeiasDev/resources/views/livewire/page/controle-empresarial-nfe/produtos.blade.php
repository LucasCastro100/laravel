<div>
            ...
            <tbody class="divide-y divide-gray-800">
                @forelse ($products as $p)
                    <tr class="hover:bg-gray-800/50">
                        ...
                        <td class="px-6 py-4">R$ {{ number_format($p->price, 2, ',', '.') }}</td>
                        <td class="px-6 py-4">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-12 text-gray-500">Nenhum produto encontrado.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="flex items-center justify-end mt-4">
        <div class="text-xs text-gray-500">
            Mostrando {{ $products->firstItem() ?? 0 }} a {{ $products->lastItem() ?? 0 }} de {{ $products->total() }} produtos
        </div>
    </div>
    ...
    @if ($showModal)
        <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-50">
            <div class="bg-gray-900 border border-gray-800 rounded-lg p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
                <h3 class="text-lg font-semibold text-white mb-4">{{ $productId ? 'Editar' : 'Novo' }} Produto</h3>
