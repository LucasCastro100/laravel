            ...
            <tbody class="divide-y divide-gray-800">
                @forelse ($produtos as $p)
                    <tr class="hover:bg-gray-800/50">
                        ...
                        <td class="px-6 py-4">
                            <span class="px-2 py-1 text-xs rounded-full {{ $p->stock == 0 ? 'bg-red-900 text-red-400' : 'bg-green-900 text-green-400' }}">
                                {{ $p->stock }}
                            </span>
                        </td>
                ...
                <form wire:submit="save" class="space-y-4">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input wire:model="stock" type="number" step="1" min="0" class="w-full bg-gray-800 border border-gray-700 text-gray-200 rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
