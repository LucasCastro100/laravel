...
import { CheckCircle2, XCircle, MapPin, Tag, Clock, DollarSign, User } from 'lucide-react';
                                ...
                                <CardContent className="space-y-3 text-sm">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        <Badge variant="outline">
                                            <Tag className="size-3" /> {listing.category}
                                        </Badge>
                                        <Badge variant="outline">{listing.intent}</Badge>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2 text-muted-foreground">
                                        ...
                                        <span>{listing.ownerName} ({listing.ownerEmail})</span>
                                    </div>
                                    ...
                                    <div className="flex gap-2 pt-2">
                                        <Form {...moderate.form(listing.id)} className="flex-1">
                    ...
                    <div className="flex items-center justify-center gap-2 pt-4">
                        {Array.from({ length: listings.last_page }, (_, i) => i + 1).map((page) => (
                            <Button
                                ...
                                size="sm"
                                onClick={() => {
                                    router.get(moderationRoute.url(), { page }, { preserveState: true });
                                }}
                            >
                                {page}
                            </Button>
