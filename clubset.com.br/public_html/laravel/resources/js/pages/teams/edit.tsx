...
export default function TeamEdit({
    ...
    // Update member role commented out per request
                        ...
                        <Heading
                            ...
                            description={
                                permissions.canCreateInvitation
                                    ? 'Gerencie quem pertence a esta equipe'
                                    : ''
                            }
                        />
                                            ...
                                            <DropdownMenuContent>
                                                {availableRoles.map((role) => (
                                                    <DropdownMenuItem
                                                        ...
                                                        // onSelect commented out per request
                                                        // onSelect={() =>
                                                        //     updateMemberRole(
                                                        //         member,
                                                        //         role.value,
                ...
                {permissions.canDeleteTeam && !team.isPersonal ? (
                    <div className="space-y-6">
                        <Heading
                            ...
                            description="Excluir sua equipe permanentemente"
                        />
                        <div className="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
                            <div className="relative space-y-0.5 text-red-600 dark:text-red-100">
                                <p className="font-medium">Aviso</p>
                                <p className="text-sm">
                                    Prossiga com cautela, isso não pode ser
                                    desfeito.
                                </p>
                            </div>
                            <Button
