        ...
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            <div className="flex items-center gap-4">
                ...
                <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground">
                        {`Adicionada em ${passkey.created_at_diff}`}
                        {passkey.last_used_at_diff && (
                            <>
                                <span className="mx-1 text-muted-foreground/50">
                                    /
                                </span>
                                {`Última vez usada em ${passkey.last_used_at_diff}`}
                            </>
                        )}
                    </p>
                </div>
            ...
            <Dialog>
                ...
                <DialogContent>
                    ...
                    <DialogDescription>
                        {`Tem certeza de que deseja remover a chave de acesso "${passkey.name}"? Você não poderá mais usá-la para entrar.`}
                    </DialogDescription>
