...
class TeacherController extends Controller
{
    ...
    public function createAndLinkStudent(Request $request, $uuid)
    {
        $course = Course::where('uuid', $uuid)->where('user_id', Auth::user()->id)->firstOrFail();
        ...
        return redirect()->route('teacher.linkCourse', $uuid)->with('success', 'Aluno criado e vinculado ao curso com sucesso!');
    }
