<x-app-layout :title="$title">
    <x-slot name="header">
        <x-page-title title="Novo Módulo" />
    </x-slot>
    ...
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
                ...
                <i class="fa-solid fa-chevron-right text-xs text-gray-700"></i>
                <span class="text-gray-300">Novo Módulo</span>
            </div>

            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-800 flex items-center gap-3">
                    <div class="w-1 h-6 bg-green-500 rounded-full"></div>
                    <h2 class="text-base font-semibold text-gray-100">Adicionar Módulo</h2>
                ...
                <form method="POST" action="{{ route('module.store', $course->uuid) }}" class="p-6 space-y-5">
                    @csrf
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                            class="block w-full bg-gray-800 text-gray-100 border border-gray-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none">{{ old('description') }}</textarea>
                    </div>
                    ...
                    <div class="flex items-center justify-between pt-5 border-t border-gray-800 mt-2">
                        ...
                        <button type="submit"
                            class="flex items-center gap-2 px-5 py-2.5 bg-green-600 hover:bg-green-500 text-white text-sm font-medium rounded-lg transition">
