                ...
                <form method="POST" action="{{ route('course.update', $course->uuid) }}" enctype="multipart/form-data" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="5"
                            class="block w-full bg-gray-800 text-gray-100 border border-gray-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none">{{ old('description', $course->description) }}</textarea>
                    </div>
