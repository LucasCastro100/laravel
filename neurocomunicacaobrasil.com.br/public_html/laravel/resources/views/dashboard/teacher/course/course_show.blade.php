            ...
            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl p-6">
                ...
                <div class="flex flex-col items-center justify-center gap-6">
                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div x-data="{ open: false, dtop: 0, dright: 0 }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                class="fixed w-52 bg-gray-800 border border-gray-700 rounded-xl shadow-xl p-1.5 z-[9999]"
                                x-transition>
                    ...
                    <div class="w-full" x-data="{ dropClassroom: [] }">
                        <div class="grid grid-cols-1 xl:grid-cols-[1.6fr_1.1fr] gap-6 w-full items-start overflow-hidden">
                            ...
                            <section class="min-w-0 rounded-2xl border border-gray-800 bg-gray-950/70 p-4 shadow-lg">
