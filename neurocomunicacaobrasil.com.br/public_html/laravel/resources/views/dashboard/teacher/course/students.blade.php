<x-app-layout :title="$title">
    ...
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            {{-- Criar e Vincular Novo Aluno --}}
            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl p-6">
                <div class="flex items-center gap-3 mb-5">
                    <div class="w-1 h-6 bg-purple-500 rounded-full"></div>
                    <h3 class="text-base font-semibold text-gray-100">Criar Novo Aluno e Vincular ao Curso</h3>
                </div>
                ...
                <form method="POST" action="{{ route('teacher.createAndLinkStudent', $course->uuid) }}">
                    @csrf
                    ...
                    <div class="flex items-center justify-end mt-5 pt-5 border-t border-gray-800">
                        <button type="submit"
