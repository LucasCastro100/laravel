                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 md:gap-6 gap-1">
                            ...
                            <div class="mb-4 relative">
                                ...
                                <label for="dropzone-file"
                                    class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-800 hover:bg-gray-700 transition">
