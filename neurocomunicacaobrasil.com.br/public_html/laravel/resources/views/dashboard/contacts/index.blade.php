                            ...
                            <div x-show="replyOpen" x-transition>
                                ...
                                <form action="{{ route($replyRoute, $contact->uuid) }}" method="POST" class="space-y-3">
                                    ...
                                    <textarea name="reply" rows="3"
                                        class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 resize-none transition"
