                                ...
                                <div class="">
                                    ...
                                    @foreach ($question['options'] as $option)
                                        ...
                                        <div class="flex flex-col md:flex-row gap-2 mt-2">
                                            <input type="number"
                                                class="w-16 bg-gray-800 border-0 border-b-2 border-gray-400 focus:ring-0 focus:border-blue-500 focus:outline-none text-gray-900 placeholder-gray-400 rounded-t-md px-2 py-1"
