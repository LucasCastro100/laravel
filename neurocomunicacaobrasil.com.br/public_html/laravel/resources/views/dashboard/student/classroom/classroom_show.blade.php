                            ...
                            <div class="bg-gray-900 rounded-2xl border border-gray-800 p-5">
                                ...
                                <form method="POST" action="{{ route('comment.store', ['uuid_classroom' => $classroom_current->uuid]) }}">
                                    ...
                                    <textarea name="comment" rows="4"
                                        class="block w-full bg-gray-800 text-gray-100 border border-gray-700 rounded-lg px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
