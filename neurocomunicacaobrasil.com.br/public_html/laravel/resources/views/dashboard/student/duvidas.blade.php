                ...
                <form action="{{ route('student.duvidas.store') }}" method="POST" class="space-y-5">
                    ...
                    <div x-show="type === 'course'" x-transition>
                        ...
                        <div class="relative" @click.away="courseOpen = false">
                            <button type="button" @click="courseOpen = !courseOpen"
                                    class="w-full flex items-center justify-between px-4 py-2.5 bg-gray-800 border border-gray-700 rounded-xl text-sm text-left transition"
                            ...
                            <div x-show="courseOpen" x-transition
                                 class="absolute z-30 w-full mt-1.5 bg-gray-800 border border-gray-700 rounded-xl shadow-xl overflow-hidden">
                    ...
                    <div>
                        ...
                        <textarea name="message" rows="5"
                            class="w-full bg-gray-800 border border-gray-700 rounded-xl px-4 py-3 text-sm text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-teal-500/40 focus:border-teal-500 resize-none transition"
