    ...
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
                ...
                <span class="text-gray-300">Editar Usuário</span>
            </div>
            ...
            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-800 flex items-center gap-3">
                    ...
                    <h2 class="text-base font-semibold text-gray-100">Editar Usuário</h2>
                </div>
                ...
                <form method="POST" action="{{ route('admin.users.update', $user->uuid) }}" class="p-6 space-y-5">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-1.5">Tipo de Usuário</label>
                            <div class="relative">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-300 mb-1.5">Nova Senha <span class="text-xs text-gray-500">(deixe em branco para manter)</span></label>
