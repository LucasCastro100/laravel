                    ...
                    <div class="flex items-center justify-between w-full">
                        ...
                        <div x-data="{ open: false }" class="relative">
                            ...
                            <div x-show="open" @click.away="open = false"
                                ...
                                <ul class="space-y-1">
                                    <li>
                                        <a href="{{ route('admin.linkCourse', $course->uuid) }}"
                                            class="block w-full text-left px-4 py-2 rounded hover:bg-green-500 hover:text-white">
                                            Vincular Alunos
                                        </a>
                                    </li>
                                    <li>
          ...
          <template x-if="openEdit">
            <div class="fixed inset-0 bg-gray-950 bg-opacity-75" @click.stop>
                <div class="flex h-full items-center justify-center p-2 sm:p-4">
                    ...
                    <form method="POST" action="{{ route('admin.courses.update', $course->uuid) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div>
                            ...
                            <input type="text" name="title" x-model="selectedCourse.title"
                                class="appearance-none mt-1 block w-full pl-3 pr-10 py-2 bg-gray-800 text-gray-100 border border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                        </div>
                        ...
                        <div class="mt-4">
                            ...
                            <textarea name="description" x-model="selectedCourse.description" rows="8" class="appearance-none mt-1 block w-full pl-3 pr-10 py-2 bg-gray-800 text-gray-100 border border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"></textarea>
                        </div>
                        ...
                        <div class="flex flex-col sm:flex-row gap-4 mt-4">
                            <div class="relative flex-1 min-w-0">
                                ...
                                <label for="dropzone-cover-edit"
                                    class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-800 hover:bg-gray-700 transition">
        ...
        <template x-if="openModule">
            <div class="fixed inset-0 bg-gray-950 bg-opacity-75" @click.stop>
                <div class="flex h-full items-center justify-center p-1">
                    ...
                    <form method="POST" action="{{ route('admin.modules.store', $course->uuid) }}">
                        @csrf
        ...
        <template x-if="editModule">
            <div class="fixed inset-0 bg-gray-950 bg-opacity-75" @click.stop>
                <div class="flex h-full items-center justify-center p-1">
                    ...
                    <form method="POST" :action="selectedModule ? '{{ url('painel-admin/modulo') }}/' + selectedModule.uuid : '#'"
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="relative mt-1">
                                <select id="module_id" name="module_id"
                                    class="appearance-none block w-full pl-3 pr-10 py-2 bg-gray-800 text-gray-100 border border-gray-700 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                                    required>
        ...
        <template x-if="editClassroom">
            <div class="fixed inset-0 bg-gray-950 bg-opacity-75" @click.stop>
                <div class="flex h-full items-center justify-center p-1">
                    ...
                    <form method="POST" :action="`{{ url('painel-admin/aula') }}/${selectClassroom.uuid}/editar`">
                        @csrf
                        @method('PUT')
                ...
                <div class="flex h-full items-center justify-center p-1">
                    ...
                    <div class="flex items-center justify-between">
                        <button type="button" @click="openDelete = false"
                            class="bg-red-500 text-white px-4 py-2 rounded">Fechar</button>
                        <form method="POST" :action="`{{ url('painel-admin') }}/${selectedType}/${selectedItem?.uuid}`">
                            @csrf
                            @method('DELETE')
                            <button type="submit"
