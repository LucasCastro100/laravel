    ...
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-6">
                <a href="{{ route('admin.courses.index') }}" class="hover:text-gray-300 transition">Cursos</a>
            ...
            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl overflow-hidden">
                ...
                <form method="POST" action="{{ route('admin.courses.store') }}" enctype="multipart/form-data" class="p-6 space-y-5">
                    @csrf
