    ...
    <div class="py-8">
        <div class="mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="flex items-center gap-2 text-sm text-gray-500 mb-2">
                <a href="{{ route('admin.users') }}" class="hover:text-gray-300 transition">Cursos</a>
                                ...
                                @foreach ($enrolledStudents as $student)
                                    <tr class="hover:bg-gray-800/40 transition">
                                        ...
                                        <td class="px-4 py-3.5">
                                            <form method="POST"
                                                action="{{ route('admin.destroyLinkCourse', ['courseUuid' => $course->uuid, 'userUuid' => $student->user->uuid]) }}"
            ...
            <div class="bg-gray-900 rounded-2xl border border-gray-800 shadow-xl p-6">
                ...
                @else
                    <form method="POST" action="{{ route('admin.storeLinkCourse', $course->uuid) }}">
                        @csrf
