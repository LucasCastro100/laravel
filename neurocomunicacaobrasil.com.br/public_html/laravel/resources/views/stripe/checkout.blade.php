<x-stripe-layout title="Finalizar Pagamento">
    ...
    <div class="bg-gray-800 shadow rounded p-4 mb-6 flex flex-row gap-4 items-center justify-center">
        <img src="{{ asset('storage/' . $course->image_cover) }}" alt="Imagem do Curso" class="w-24 h-24 object-cover rounded">
        <div>
