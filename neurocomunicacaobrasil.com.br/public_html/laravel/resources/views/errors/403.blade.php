...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .icon { width: 72px; height: 72px; background: rgba(239,68,68,0.1); border: 1px solid rgba(239,68,68,0.2); border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.5rem; }
        .icon i { font-size: 1.75rem; color: #f87171; }
...
<body>
    <div class="card">
        ...
        <h1>Acesso Negado</h1>
        <p>Você não tem permissão para acessar esta página. Se acredita que isso é um erro, entre em contato com o administrador.</p>
        <div>
