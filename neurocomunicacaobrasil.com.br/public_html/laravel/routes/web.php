...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    // Rotas compartilhadas (professor role:2 + admin role:3)
    ...
    Route::prefix('painel-professor')->middleware(['role:2'])->group(function () {
        ...
        Route::controller(TeacherController::class)->group(function () {
            ...
            Route::post('/curso/{uuid}/criar-e-vincular-aluno', 'createAndLinkStudent')->name('teacher.createAndLinkStudent');
    ...
    Route::prefix('painel-admin')->middleware(['role:3'])->group(function () {
        ...
        Route::controller(AdminController::class)->group(function () {
            ...
            Route::get('/testes', 'tests')->name('admin.tests');
            ...
            Route::get('/curso/{uuid}/vincular-alunos', 'linkCourse')->name('admin.linkCourse');
            Route::post('/curso/{uuid}/vincular-alunos', 'storeLinkCourse')->name('admin.storeLinkCourse');
            Route::delete('/curso/{courseUuid}/vincular-alunos/{userUuid}', 'destroyLinkCourse')->name('admin.destroyLinkCourse');
        });
    });
});
